...
import { validateExistAuthor, validateOtherAuthor } from './autor.valid.db.js'
...
export const validateUpdateAuthor = async ({ names, country, idAutor }) => {
  await validateOtherAuthor({ names, country, idAutor })
}
